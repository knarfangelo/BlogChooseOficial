...
@Component({
  selector: 'app-empresas-que-triunfaron-gracias-al-social-listening-casos-de-exito-inspiradores',
  standalone: true,
  imports: [
    CommonModule,
  ],
  ...
  styleUrl: './empresas-que-triunfaron-gracias-al-social-listening-casos-de-exito-inspiradores.component.css',
